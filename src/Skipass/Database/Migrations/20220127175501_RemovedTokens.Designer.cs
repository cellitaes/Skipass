...
namespace Skipass.Database
{
    ...
    [Migration("20220127175501_RemovedTokens")]
    partial class RemovedTokens
    {
            ...
            modelBuilder.Entity("Skipass.Domain.Card", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Identifier = "921212",
                            PassagesLeft = 2,
                            ValidTo = new DateTime(2022, 1, 27, 17, 55, 0, 992, DateTimeKind.Utc).AddTicks(7254)
                        },
                        new
                        {
                            Identifier = "792922",
                            PassagesLeft = 15,
                            ValidTo = new DateTime(2022, 1, 27, 17, 55, 0, 992, DateTimeKind.Utc).AddTicks(7266)
                        },
                        new
                        {
                            Identifier = "533333",
                            PassagesLeft = 0,
                            ValidTo = new DateTime(2022, 1, 27, 18, 10, 0, 992, DateTimeKind.Utc).AddTicks(7268)
                        });
                });
