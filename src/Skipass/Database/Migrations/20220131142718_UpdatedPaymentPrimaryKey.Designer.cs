...
namespace Skipass.Database
{
    ...
    [Migration("20220131142718_UpdatedPaymentPrimaryKey")]
    partial class UpdatedPaymentPrimaryKey
    {
            ...
            modelBuilder.Entity("Skipass.Domain.Card", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Identifier = "921212",
                            PassagesLeft = 2,
                            ValidTo = new DateTime(2022, 1, 31, 14, 27, 18, 372, DateTimeKind.Utc).AddTicks(2124)
                        },
                        new
                        {
                            Identifier = "792922",
                            PassagesLeft = 15,
                            ValidTo = new DateTime(2022, 1, 31, 14, 27, 18, 372, DateTimeKind.Utc).AddTicks(2137)
                        },
                        new
                        {
                            Identifier = "533333",
                            PassagesLeft = 0,
                            ValidTo = new DateTime(2022, 1, 31, 14, 42, 18, 372, DateTimeKind.Utc).AddTicks(2139)
                        });
                });
