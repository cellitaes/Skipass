...
namespace Skipass.Database
{
    ...
    [Migration("20220127174325_AddedCompanies")]
            ...
            modelBuilder.Entity("Skipass.Domain.Card", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Identifier = "921212",
                            PassagesLeft = 2,
                            ValidTo = new DateTime(2022, 1, 27, 17, 43, 25, 271, DateTimeKind.Utc).AddTicks(3555)
                        },
                        new
                        {
                            Identifier = "792922",
                            PassagesLeft = 15,
                            ValidTo = new DateTime(2022, 1, 27, 17, 43, 25, 271, DateTimeKind.Utc).AddTicks(3570)
                        },
                        new
                        {
                            Identifier = "533333",
                            PassagesLeft = 0,
                            ValidTo = new DateTime(2022, 1, 27, 17, 58, 25, 271, DateTimeKind.Utc).AddTicks(3572)
                        });
                });
